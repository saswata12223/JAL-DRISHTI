...
class PredictionService:
    ...
    def _load_engine(self):
        try:
            ...
            allowlist_path = Path(settings.ML_ALLOWLIST_PATH)
            if model_path.exists() and allowlist_path.exists():
                ...
                logger.warning("ML model or allowlist file not found at configured path.")
                self._engine = None
