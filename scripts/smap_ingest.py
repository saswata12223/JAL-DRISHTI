...
class SMAPIngestionEngine:
    ...
    def __init__(self, days_back: int = DEFAULT_DAYS, start_date: Optional[Any] = None, end_date: Optional[Any] = None):
        ...
        if end_date:
            ...
            if isinstance(end_date, str):
                ...
                self.end_date = datetime.strptime(end_date[:10], "%Y-%m-%d").date()
        ...
        if start_date:
            ...
            if isinstance(start_date, str):
                ...
                self.start_date = datetime.strptime(start_date[:10], "%Y-%m-%d").date()
...
def main():
    ...
    parser = argparse.ArgumentParser(description="NASA SMAP Soil Moisture Ingestion")

    parser.add_argument("--days-back", type=int, default=DEFAULT_DAYS, help="Number of historical days to fetch")
    ...
    engine = SMAPIngestionEngine(days_back=args.days_back, start_date=args.start_date, end_date=args.end_date)
